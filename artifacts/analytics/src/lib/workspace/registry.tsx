...
export const pluginRegistry: PluginManifest[] = [
  createPluginManifest({
    ...
    roleRelevance: ["executive", "marketing", "product", "design", "customer-success"],
  ...
  createPluginManifest({
    ...
    capabilityLevel: "core",
    roleRelevance: ["marketing", "product", "design"],
    defaultSize: { w: 320, h: 184 },
  }),
  createPluginManifest({
    id: "experiments",
    ...
    roleRelevance: ["marketing", "product", "design", "executive"],
    defaultSize: { w: 320, h: 184 },
  }),
  createPluginManifest({
    id: "feature-flags",
    ...
    capabilityLevel: "advanced",
    roleRelevance: ["product", "engineering", "operations"],
    defaultSize: { w: 320, h: 184 },
  }),
  createPluginManifest({
    id: "revenue",
    ...
    capabilityLevel: "core",
    roleRelevance: ["executive", "finance", "marketing", "customer-success"],
    defaultSize: { w: 320, h: 184 },
  }),
  createPluginManifest({
    id: "engineering",
    ...
    capabilityLevel: "core",
    roleRelevance: ["executive", "engineering", "operations", "product"],
    defaultSize: { w: 320, h: 184 },
  }),
  createPluginManifest({
    id: "observability",
    ...
    capabilityLevel: "core",
    roleRelevance: ["engineering", "operations", "finance", "customer-success"],
    defaultSize: { w: 320, h: 184 },
  }),
  createPluginManifest({
    id: "insights",
    label: "Insights",
    shortLabel: "Insights",
    description: "Leitura sintetica, alertas e narrativa por cargo.",
    icon: Sparkles,
    accentClassName: "text-cyan-300",
    capabilityLevel: "core",
    roleRelevance: ["executive", "finance", "marketing", "product", "operations"],
    defaultSize: { w: 320, h: 184 },
  }),
  createPluginManifest({
    id: "agents",
    label: "Agents",
    shortLabel: "Agents",
    description: "Agentes de apoio, topologia de IA e supervisao operacional.",
    icon: BrainCircuit,
    accentClassName: "text-indigo-300",
    capabilityLevel: "beta",
    roleRelevance: ["executive", "engineering", "operations", "finance", "marketing"],
    defaultSize: { w: 320, h: 184 },
  }),
];
...
const defaultConnections: PluginConnectionRule[] = [
  ...
  { source: "analytics", target: "agents", label: "context", layer: "flows", kind: "automation" },
  { source: "revenue", target: "agents", label: "finance context", layer: "flows", kind: "automation" },
  { source: "engineering", target: "agents", label: "delivery context", layer: "flows", kind: "automation" },
  { source: "observability", target: "agents", label: "ops context", layer: "flows", kind: "automation" },
  { source: "insights", target: "agents", label: "recommendations", layer: "flows", kind: "automation" },
];
...
function createCatalogItem(
  input: Omit<WorkspaceCatalogItem, "recommendedFor"> & { recommendedFor?: WorkspaceRoleId[] },
): WorkspaceCatalogItem {
  return {
    ...input,
...
function getItemDefaultSize(mode: TelemetryItemMode, item?: TelemetryItemDefinition) {
  switch (mode) {
    ...
    case "canvas":
      return { w: 360, h: 212 };
    case "custom":
      if (item?.specialKind === "terminal") return { w: 520, h: 320 };
...
export function buildWorkspaceCatalog(options: {
  ...
  const templateItems = pluginRegistry.map((plugin) =>
    createCatalogItem({
      ...
      kind: "plugin",
      category: plugin.id === "agents" ? "agents" : "templates",
      label: plugin.label,
      ...
      recommendedFor: plugin.roleRelevance,
    }),
  );
