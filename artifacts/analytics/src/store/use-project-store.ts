...
interface ProjectStore {
  ...
  defaultTeamPersonaId: TeamPersonaId;
  setDefaultTeamPersonaId: (personaId: TeamPersonaId) => void;
  teamPersonaByProject: Record<string, TeamPersonaId>;
  setProjectTeamPersona: (projectId: string, personaId: TeamPersonaId) => void;
...
export const useProjectStore = create<ProjectStore>()(
  persist(
    (set, get) => ({
      ...
      defaultTeamPersonaId,
      setDefaultTeamPersonaId: (personaId) => set({ defaultTeamPersonaId: personaId }),
      teamPersonaByProject: {},
      setProjectTeamPersona: (projectId, personaId) =>
        set((state) => ({
          teamPersonaByProject: {
            ...state.teamPersonaByProject,
            [projectId]: personaId,
          },
        })),
      dateRange: {
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        defaultTeamPersonaId: state.defaultTeamPersonaId,
        teamPersonaByProject: state.teamPersonaByProject,
